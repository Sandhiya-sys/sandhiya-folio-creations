    ...
    <div className="max-w-5xl mx-auto space-y-10">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <ScrollReveal delay={0.1} direction="left">
          <Card className="bg-card border border-primary/10 glow-border hover:border-primary/30 transition-all duration-300 h-full">
        ...
        <ScrollReveal delay={0.2} direction="right">
          <Card className="bg-card border border-accent/10 hover:border-accent/30 transition-all duration-300 h-full" style={{ boxShadow: '0 0 15px hsl(260 80% 60% / 0.1)' }}>
            <CardContent className="p-6 space-y-4">
              <div className="flex items-center gap-3">
