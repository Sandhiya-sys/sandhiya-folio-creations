      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {projects.map((p, i) => (
          <ScrollReveal key={p.title} delay={i * 0.12}>
            <Card className="group bg-card border border-primary/10 glow-border hover:border-primary/40 hover:-translate-y-1 transition-all duration-300 overflow-hidden h-full">
